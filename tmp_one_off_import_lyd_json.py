...
def write_label_jsons( lyd_json):
    ...
    with open(lyd_json, "r") as f:
        ...
        for img_id, idx_info in idx_to_img.items():
            ...
            out_file_name = os.path.join(parent, os.path.splitext ( crop_file_name )[0] +".json" )
...
json_src.extend(glob.glob(r'C:\Users\twak\Downloads\Pilot\Pilot (with layers)\**.json'))
