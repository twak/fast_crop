...
def write_label_jsons( lyd_json):
    ...
    with open(lyd_json, "r") as f:
        ...
        out_file_name = os.path.join(parent.parent,  "labels_"+ Path(lyd_json).parent.name,
                                     os.path.splitext ( crop_file_name )[0] +".json" )
...
if __name__ == "__main__":
    ...
    json_src.extend(glob.glob(r'C:\Users\twak\Documents\architecture_net\windows_part3\all_labels_so_far\**.json'))
