...
def render_labels_per_crop( dataset_root, json_file, output_folder, reses=[512], mode='None', render_svg=False):
    ...
    for res in reses:
        ...
        for crop_name, crop_data in data.items():
            ...
            out.append((res, country, base_name))
...
if __name__ == "__main__":
    ...
    if True: # threaded
        with concurrent.futures.ThreadPoolExecutor(max_workers=32) as _pool:
            ...
            futures = [_pool.submit( render_labels_per_crop, dataset_root, f, output_folder, reses=[256,512,1024,2048], mode='square_crop') for f in json_src]

            print ("all jobs submitted!")

            for r in concurrent.futures.as_completed(futures):
                for res, country, base_name in r.result():
